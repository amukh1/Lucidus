...
entry:
  ...
  %1 = load i32, i32* %x
  %2 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([32 x i8], [32 x i8]* @str.1, i32 0, i32 0), i32 %1)
  store i32 4, i32* %x
  %3 = load i32, i32* %x
  %4 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @str.2, i32 0, i32 0), i32 %3)
  store i32 0, i32* %x
  %5 = load i32, i32* %x
  ret i32 %5
}
