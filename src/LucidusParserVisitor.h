...
public:
   ...
   */
    ...
    virtual std::any visitInfdec(LucidusParser::InfdecContext *context) = 0;

    virtual std::any visitEdec(LucidusParser::EdecContext *context) = 0;

    virtual std::any visitAssign(LucidusParser::AssignContext *context) = 0;

    virtual std::any visitLabel(LucidusParser::LabelContext *context) = 0;

    virtual std::any visitGoto(LucidusParser::GotoContext *context) = 0;

    virtual std::any visitIf(LucidusParser::IfContext *context) = 0;

    virtual std::any visitWhile(LucidusParser::WhileContext *context) = 0;

    virtual std::any visitImrt(LucidusParser::ImrtContext *context) = 0;
