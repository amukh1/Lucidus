...
@str.1 = private constant [9 x i8] c"FCar.txt\00"
@str.2 = private constant [3 x i8] c"r+\00"
@str.3 = private constant [13 x i8] c"Car Make: %s\00"
@str.4 = private constant [14 x i8] c"Car Model: %s\00"
@str.5 = private constant [17 x i8] c"Car Mileage: %d\0A\00"
@str.6 = private constant [14 x i8] c"Car Year: %d\0A\00"
@str.7 = private constant [14 x i8] c"Car Cost: %d\0A\00"
...
entry:
  ...
  store i8* %10, i8** %cost
  %fstream = alloca i8*
  %11 = call i8* @fopen(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @str.1, i32 0, i32 0), i8* getelementptr inbounds ([3 x i8], [3 x i8]* @str.2, i32 0, i32 0))
  ...
  %47 = load i8*, i8** %46
  %48 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @str.3, i32 0, i32 0), i8* %47)
  %49 = load %Car*, %Car** %FCar
  %50 = getelementptr inbounds %Car, %Car* %49, i32 0, i32 1
  %51 = load i8*, i8** %50
  %52 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @str.4, i32 0, i32 0), i8* %51)
  %53 = load %Car*, %Car** %FCar
  %54 = getelementptr inbounds %Car, %Car* %53, i32 0, i32 2
  %55 = load i32, i32* %54
  %56 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @str.5, i32 0, i32 0), i32 %55)
  %57 = load %Car*, %Car** %FCar
  %58 = getelementptr inbounds %Car, %Car* %57, i32 0, i32 3
  %59 = load i32, i32* %58
  %60 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @str.6, i32 0, i32 0), i32 %59)
  %61 = load %Car*, %Car** %FCar
  %62 = getelementptr inbounds %Car, %Car* %61, i32 0, i32 4
  %63 = load i32, i32* %62
  %64 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @str.7, i32 0, i32 0), i32 %63)
  ret i32 0
}
